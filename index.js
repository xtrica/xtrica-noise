/*
 * xtrica-noise v1.0.1515209187 (https://xtrica.com)
...
this.add=function(key,audioObject,defaultVolume=100){this.noises[key.toLowerCase()]=[audioObject,(Math.abs(parseInt(defaultVolume))/100),!1]
vm.noises[key][0].addEventListener('canplaythrough',function(){vm.noises[key][2]=!0})
vm.noises[key][0].addEventListener('unhandledrejection',function(error){throw error})}}